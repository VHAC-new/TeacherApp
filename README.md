...
* [S3 — IAM e CORS](docs/backend/s3-iam-cors.md)
* [S3 — checklist de ambiente](docs/backend/s3-environment-checklist.md)
* [S3 — smoke test presigned](docs/backend/s3-smoke-test.md)
